import { BackIcon, OVER18_1, OVER18_2 } from '@/assets/images/svg';
...
export default function OTPEntryScreen() {
  ...
  const { nokEmail } = useNokEmailStore();
  ...
  const handleProceed = () => {
    if (isValid) {
      router.push('/sign-up-nok/over18/upload');
    }
  };
