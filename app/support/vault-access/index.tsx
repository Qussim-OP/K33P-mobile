...
export default function VaultAccessHelpScreen() {
  ...
  const vaultContent = helpContent.helpSections.find(section => section.section === 'Vault Access');
  ...
  const performSearch = (query: string) => {
                ...
                {contentItem.id === 1 ? (
                  <>
                    <Text className="text-main">
                      {highlightText('Loss of device - ', query)}
                    </Text>
    ...
    const sortedResults = results.sort((a, b) => {
      if (a.section === 'Vault Access') return -1;
      if (b.section === 'Vault Access') return 1;
      return 0;
    });
    ...
    <TouchableWithoutFeedback onPress={() => {
      ...
      <View className="flex-1">
        ...
        <View className="flex-1">
          ...
          {/* Regular Vault Access Content (only shown when not searching) */}
          {!searchQuery && (
            <ScrollView 
            ...
            >
              <View className='p-4 rounded-lg mt-4 bg-[#222222]'>
                ...
                {vaultContent.content.map((section) => (
