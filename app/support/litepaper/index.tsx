...
export default function LightpaperHelpScreen() {
  ...
  const lightpaperContent = helpContent.helpSections.find(section => section.section === 'Lightpaper');
    ...
    <TouchableWithoutFeedback onPress={() => {
      ...
      <View className="flex-1">
        ...
        <View className="flex-1">
          ...
          {/* Regular Lightpaper Content (only shown when not searching) */}
          {!searchQuery && (
            <ScrollView 
            ...
            >
              <View className='p-4 rounded-lg mt-4 bg-[#222222]'>
                ...
                {lightpaperContent.content.map((section) => (
